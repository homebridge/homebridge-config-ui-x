...
import { AccessoryLayout, MatterControlResponse, ServiceTypeX } from '@/app/core/accessories/accessories.interfaces'
...
export class AccessoriesService {
  ...
  /**
   * Control a Matter accessory by updating cluster attributes
   */
  public controlMatterAccessory(uuid: string, cluster: string, attributes: Record<string, unknown>, bridgeUsername?: string, partId?: string): Promise<MatterControlResponse> {
    return firstValueFrom(this.$api.post('/accessories/matter/control', {
      uuid,
      cluster,
      attributes,
      bridgeUsername,
      partId,
    })) as Promise<MatterControlResponse>
  }
}
